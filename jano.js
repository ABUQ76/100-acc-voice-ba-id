...
///////////////////
jano.on("ready", () => {
    var join = jano.channels.get("904003250280357901"); /// id voice
    if (join) join.join();
  });
///////////////////
jano2.on("ready", () => {
    var join = jano2.channels.get("904003250280357901"); /// id voice
    if (join) join.join();
  });
///////////////////
jano3.on("ready", () => {
...
jano.login("OTA0MTI4MTg3OTE3ODAzNjIw.YX3A_Q.qsgXdwm9u_URhqOwtmQP5AAMaT4");
jano2.login("");
jano3.login("");
jano4.login("");
jano5.login("");
